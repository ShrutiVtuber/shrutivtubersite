...
D4 = {
    "game": "diablo-iv",
    "sections": [
        {"id": "spec", "name": "Specialization", "type": "picks", "kind": "specialization", "by_class": True, "max": 6, "track": "check",
         "fields": {"note": {"type": "text"}}},
        {"id": "skills", "name": "Skills", "type": "picks", "kind": "skill", "by_class": True, "max": 24, "track": "check",
         "sub": ["active", "passive", "key-passive", "ultimate", "basic", "core", "defensive", "mastery", "capstone"],
         "fields": {"ranks": {"type": "int", "min": 1, "max": 5, "unit": "ranks"}, "upgrades": {"type": "within", "list": "upgrades", "max": 2}},
        ...
        {"id": "gear", "name": "Gear", "type": "gear", "grid": True,
         "fields": {"unique": {"type": "id", "kind": "unique"}, "base": {"type": "id", "kind": "base"}, "aspect": {"type": "id", "kind": "aspect"},
                    "affixes": {"type": "ids", "kind": "affix", "max": 4}, "greater": {"type": "ids", "kind": "affix", "max": 3},
        ...
        {"id": "charms", "name": "Charms", "type": "picks", "kind": "charm", "by_class": True, "max": 8, "track": "check",
         "fields": {"note": {"type": "text"}}},
    ...
    "sections": [
        ...
        {"id": "gear", "name": "Gear", "type": "gear", "grid": True,
         "fields": {"unique": {"type": "id", "kind": "unique"}, "base": {"type": "id", "kind": "base"},
                    "affixes": {"type": "ids", "kind": "affix", "max": 6}, "runes": {"type": "ids", "kind": "rune", "max": 3},
...
D2R = {
    ...
    "sections": [
        ...
        {"id": "merc-gear", "name": "Mercenary gear", "type": "gear", "slots": ["helm", "body-armor", "weapon", "shield"],
         "fields": {"runeword": {"type": "id", "kind": "runeword"}, "unique": {"type": "id", "kind": "unique"}, "base": {"type": "id", "kind": "base"},
                    "note": {"type": "text"}}},
        {"id": "targets", "name": "Numbers", "type": "targets",
